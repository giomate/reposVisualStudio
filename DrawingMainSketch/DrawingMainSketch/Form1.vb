...
Public Class Form1
    ...
    Public refDoc As FindReferenceLine
    ...
    Public Function StartDrawing() As Boolean
        ...
        Try
            If (started And (Not running)) Then
                ...
                mainSketch = New Sketcher3D(trobinaCurve.oDoc)
                mainSketch.StartDrawingTranslated(refDoc, 1)

                b = mainSketch.IsDocHealthy()
            End If
            Return b
        Catch ex As Exception
            Debug.Print(ex.ToString())
