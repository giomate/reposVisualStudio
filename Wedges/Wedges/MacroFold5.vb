...
Public Class MacroFold5
    ...
    Function AdjustLastAngle() As Boolean
        ...
        Try
            ...
            d = CalculateRoof()
            If d > 0 Then
                If adjuster.AdjustGapSmothly(gapFold, gap1CM, ac) Then
                    Try
                        While (ac.Parameter._Value < angleLimit And ac.Parameter._Value > angleLimit / 2) And counterLimit < 4
                            ...
                            adjuster.AdjustGapSmothly(gapFold, gap1CM * 9 / 8, ac)
            ...
            Else
                Try
                    ...
                    ac.Driven = True
                    While ((d < 0 Or ac.Parameter._Value > Math.PI - limit / 2) And counterLimit < 32)
                        Try
