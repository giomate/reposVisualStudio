...
#End If
                                        ...
                                        If bender.GetFoldingAngle(leadingEdge, sl).Parameter._Value > 0 Then
                                            ...
                                            If monitor.IsFeatureHealthy(folded) Then
                                                ...
                                                If compDef.HasFlatPattern Then
                                                    ...
                                                    sk3D.Name = "nextline"
                                                    sk3D = compDef.Sketches3D.Add()
                                                    connectLine = nextSketch.constructionLines.Item(nextSketch.constructionLines.Count)
    ...
    Function ReduceGap(ng As DimensionConstraint3D) As Boolean
        ...
        Try
            ...
            dc.Driven = True
            If gapFold.Parameter._Value < gap1CM * 2 Then
    ...
    Function DrawSecondConstructionLine() As SketchLine3D
        Try
            ...
            Try
                sk3D.Solve()
            Catch ex As Exception
                RegenerateGapVertex(False)
                adjuster.AdjustDimConstrain3DSmothly(gapVertex, gapVertex.Parameter._Value / 2)
                gapVertex.Driven = True
            End Try
            Try
...
#End If
                ...
                sk3D.GeometricConstraints3D.AddGround(sptRFront)
                dc = sk3D.DimensionConstraints3D.AddTwoPointDistance(l.EndPoint, sptRFront)
