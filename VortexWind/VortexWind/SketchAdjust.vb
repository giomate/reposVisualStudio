...
Public Class SketchAdjust
    ...
    Function iterate(name As String, setpoint As Double) As Parameter
    ...
    Function AdjustResolution2D(dc As DimensionConstraint, s As Double) As Double
        ...
        Return c
    End Function
    Sub checkOtherVariables(name As String)
    ...
    End Sub
    Function checkDimension(name As String, a As Double, b As Double, setpoint As Double) As Parameter
        p = getParameter(name)
        ...
        Return p
    End Function
    Function checkAngulos(name As String, a As Double, b As Double, setpoint As Double) As Parameter
        p = getParameter(name)
