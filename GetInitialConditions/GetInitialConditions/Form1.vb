...
Public Class Form1
    ...
    Dim keyline As FindReferenceLine
    ...
    Private Sub Form1_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        ...
        End Try
    End Sub
    Public Function StartSearcher() As Boolean
        Dim b As Boolean
        Try
            If (started And (Not running)) Then
                invDoc = New InventorFile(oApp)
                keyline = New FindReferenceLine(invDoc.openFile("BandFoldingIteration0.ipt"))
                keyline.DrawKeyLine(keyline.GetKeyLine())
                b = True
            End If
        ...
        Return b
    End Function
    Public Function StartSearcher(App As Inventor.Application) As Boolean
        Dim b As Boolean
        Try
            b = StartSearcher()
        Catch ex As Exception
