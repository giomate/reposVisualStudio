  ...
  The two combo boxes allow you to specify the height and width of the slot sketch. If you run the "Draw Slot" command and a sketch is active, it will draw a shape in the active sketch. If you run the "Add slot width/height" command it will add one more entry in the combo boxes for width and height. The "Toggle Slot State" command toggles the "Draw Slot" command.
