...
namespace DebugPluginLocally1Plugin
{
    [Guid("148013e4-dca9-401b-92a0-9b8fb9c61f27")]
    public class PluginServer : ApplicationAddInServer
    {
        ...
        {
            Trace.TraceInformation(": DebugPluginLocally1Plugin (" + Assembly.GetExecutingAssembly().GetName().Version.ToString(4) + "): initializing... ");
        ...
        {
            Trace.TraceInformation(": DebugPluginLocally1Plugin: deactivating... ");
